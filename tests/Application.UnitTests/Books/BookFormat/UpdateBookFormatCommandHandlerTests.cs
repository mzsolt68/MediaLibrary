...
{
    public class UpdateBookFormatCommandHandlerTests
    {
        private readonly Mock<IUnitOfWork> _unitOfWork;

        public UpdateBookFormatCommandHandlerTests()
        {
        ...
        [Fact]
        public async Task ProperParametersShouldUpdateBookFormat()
        {
            // Arrange
            ...
            // Act
            var handler = new UpdateBookFormatCommandHandler(_unitOfWork.Object);
