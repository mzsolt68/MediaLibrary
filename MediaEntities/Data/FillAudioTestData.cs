...
namespace MediaLibrary.Entities.Data
{
    ...
    {
        public static void MakeManyToManyConnections(ModelBuilder builder)
        {
        ...
        public static void FillSongs(ModelBuilder builder)
        {
            ...
            builder.Entity<AlbumSong>().HasData(
                new AlbumSong { AlbumID = 1, SongID = 1, TrackNr = 1, PlayTime = Convert.ToDateTime("4:15"), Disc = 1 },
                new AlbumSong { AlbumID = 1, SongID = 2, TrackNr = 2, PlayTime = Convert.ToDateTime("3:26"), Disc = 1 },
                new AlbumSong { AlbumID = 1, SongID = 3, TrackNr = 3, PlayTime = Convert.ToDateTime("3:56"), Disc = 1 },
                new AlbumSong { AlbumID = 1, SongID = 4, TrackNr = 4, PlayTime = Convert.ToDateTime("4:00"), Disc = 1 },
                new AlbumSong { AlbumID = 1, SongID = 5, TrackNr = 5, PlayTime = Convert.ToDateTime("4:24"), Disc = 1 },
                new AlbumSong { AlbumID = 1, SongID = 6, TrackNr = 6, PlayTime = Convert.ToDateTime("4:05"), Disc = 1 },
                new AlbumSong { AlbumID = 1, SongID = 7, TrackNr = 7, PlayTime = Convert.ToDateTime("3:55"), Disc = 1 },
                new AlbumSong { AlbumID = 1, SongID = 8, TrackNr = 8, PlayTime = Convert.ToDateTime("3:16"), Disc = 1 },
                new AlbumSong { AlbumID = 1, SongID = 9, TrackNr = 9, PlayTime = Convert.ToDateTime("3:25"), Disc = 1 },
                new AlbumSong { AlbumID = 1, SongID = 10, TrackNr = 10, PlayTime = Convert.ToDateTime("4:20"), Disc = 1 },
                new AlbumSong { AlbumID = 1, SongID = 11, TrackNr = 11, PlayTime = Convert.ToDateTime("4:01"), Disc = 1 },
                new AlbumSong { AlbumID = 1, SongID = 12, TrackNr = 12, PlayTime = Convert.ToDateTime("2:30"), Disc = 1 },
                new AlbumSong { AlbumID = 1, SongID = 13, TrackNr = 13, PlayTime = Convert.ToDateTime("4:24"), Disc = 1 },
                new AlbumSong { AlbumID = 1, SongID = 14, TrackNr = 14, PlayTime = Convert.ToDateTime("3:49"), Disc = 1 },
                new AlbumSong { AlbumID = 1, SongID = 15, TrackNr = 15, PlayTime = Convert.ToDateTime("2:50"), Disc = 1 },
                new AlbumSong { AlbumID = 1, SongID = 16, TrackNr = 16, PlayTime = Convert.ToDateTime("3:58"), Disc = 1 },
                new AlbumSong { AlbumID = 1, SongID = 17, TrackNr = 17, PlayTime = Convert.ToDateTime("2:25"), Disc = 1 },
                new AlbumSong { AlbumID = 1, SongID = 18, TrackNr = 18, PlayTime = Convert.ToDateTime("4:11"), Disc = 1 },
                new AlbumSong { AlbumID = 1, SongID = 19, TrackNr = 19, PlayTime = Convert.ToDateTime("3:56"), Disc = 1 },
                new AlbumSong { AlbumID = 1, SongID = 20, TrackNr = 20, PlayTime = Convert.ToDateTime("3:51"), Disc = 1 },
                new AlbumSong { AlbumID = 2, SongID = 21, TrackNr = 20, PlayTime = Convert.ToDateTime("3:52"), Disc = 1 },
                new AlbumSong { AlbumID = 2, SongID = 22, TrackNr = 1, PlayTime = Convert.ToDateTime("3:45"), Disc = 1 },
                new AlbumSong { AlbumID = 4, SongID = 22, TrackNr = 3, PlayTime = Convert.ToDateTime("3:45"), Disc = 1 }
                );
        }
    }
}
